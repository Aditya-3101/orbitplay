...
export const VideoCard_v2 = (props) => {
  ...
  return (
    <div>
        <div className='grid grid-cols-[40%_60%] grid-rows-[6rem] md:grid-rows-[12rem] md:grid-cols-[40%_60%] lg:grid-cols-[30%_70%] gap-2 my-4'>
            <section className='relative flex justify-center'>
                <img src={par?.thumbnail} className='w-[100%] aspect-video object-cover block' />
