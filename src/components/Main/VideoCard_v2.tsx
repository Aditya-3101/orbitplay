  ...
  return (
    <div>
        <div className='grid grid-cols-[40%_60%] grid-rows-[6rem] md:grid-rows-[10rem] lg:grid-rows-[12rem] md:grid-cols-[40%_60%] lg:grid-cols-[35%_65%] xl:grid-cols-[30%_70%] gap-4 my-4 relative'>
            ...
            <section className='grid grid-rows-[25%_75%] md:grid-rows-[30%_70%] relative w-[100%] aspect-[16/9] h-[100%]'>
                ...
                <p className=' text-slate-500 text-sm font-roboto w-[80%]'>{par.description}</p>
