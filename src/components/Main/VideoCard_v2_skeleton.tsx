...
const VideoCard_v2_skeleton:React.FC = () => {
  return (
    <div>
        <div>
        <div className='grid grid-cols-[40%_60%] grid-rows-[6rem] md:grid-rows-[10rem] lg:grid-rows-[10rem] md:grid-cols-[40%_60%] lg:grid-cols-[35%_65%] gap-2 my-4 border border-gray-500'>
