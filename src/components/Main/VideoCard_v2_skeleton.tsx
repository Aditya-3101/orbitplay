...
const VideoCard_v2_skeleton = () => {
  return (
    <div>
        <div>
        <div className='grid grid-cols-[40%_60%] grid-rows-[6rem] md:grid-rows-[10rem] lg:grid-rows-[12rem] md:grid-cols-[40%_60%] lg:grid-cols-[30%_70%] gap-2 my-4 border border-gray-500'>
            ...
            <section className='flex flex-col gap-1 md:gap-2 justify-around relative w-[100%] aspect-[16/9] h-[100%]'>
