...
export const VideoCard = ({data}) => {
    ...
    <div className='w-[100%] md:my-4'>
        <div className='border border-gray-200 rounded w-[90%] mx-auto aspect-video'>
            ...
            <img src={owner?.avatar} className='rounded-full aspect-square w-[2rem] object-cover mx-auto' />
